...
Toda alteração de catálogo é feita editando `backend/database/seed.py` (adicionando, removendo ou alterando as chamadas `add_fixed_product`, 
`add_configurable_product`, `add_variant`, `add_option_group`, `add_option`) e rodando de novo:
